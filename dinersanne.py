...
with tab2:
    ...
    with col2:
        ...
        IMG_DIR_2 = Path("Afbeeldingen eten")
        img_path_2 = IMG_DIR_2 / "afbeelding_scampi_test.jpg"
        # afbeelding = Image.open("C:/Users/Gebruiker/Downloads/afbeelding_scampi_test.jpg")
        afbeelding = Image.open(img_path_2)
...
with tab3:
    ...
    with col2:
        ...
        IMG_DIR_3 = Path("Afbeeldingen eten")
        img_path_3 = IMG_DIR_3 / "433235a9-0dc4-4a23-9763-1928519cf433.JPG"
        ...
        afbeelding = Image.open(img_path_3)
        st.image(maak_vierkant(afbeelding, grootte=300))
...
with tab4:
    ...
    with col2:
        ...
        with sub_col2:
            IMG_DIR_7 = Path("Afbeeldingen eten")
            img_path_7 = IMG_DIR_7 / "basil-smash-800x600.png"
            ...
            afbeelding2 = Image.open(img_path_7)
